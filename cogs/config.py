...
YTDL_FORMAT_OPTIONS = {
    ...
    'noplaylist': True,
    # SSL verification enabled for security (set to False only if needed)
    ...
    'no_warnings': True,
    'default_search': 'auto',
    # Use default source address (more secure than 0.0.0.0)
    # Uncomment below if you have network issues:
